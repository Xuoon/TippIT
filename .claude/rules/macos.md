...
- Historie-Fenster bleibt eine Tauri-show/hide-Sache; die App ist Accessory (kein Dock-Icon — `LSUIElement` in `src-tauri/Info.plist` + ActivationPolicy in `lib.rs`).
